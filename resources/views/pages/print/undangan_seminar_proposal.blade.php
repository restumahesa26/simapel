    ...
    <div class="container" style="padding-left: 50px; padding-right: 50px;">
        ...
        <table class="table table-borderless mt-5">
            <tbody class="table-yth">
                ...
                <tr>
                    <td>Ketua/Sekretaris/Anggota Tim Penguji Seminar Proposal</td>
                </tr>
                <tr>
        ...
        <p class="mt-4 text-justify" style="text-indent: 50px;">Dengan hormat, dalam rangka pelaksanaan seminar proposal mahasiswa Fakultas Syariah IAIN Kerinci, kami mohon kesediaan Bapak/Ibu/Sdr/Sdri sebagai Ketua/Sekretaris/Anggota Tim Penguji pada seminar proposal dimaksud sebagaimana jadwal terlampir.</p>
        <p class="mt-4" style="text-indent: 50px;">Demikian disampaikan, atas kerja sama yang baik diucapkan terima kasih</p>
