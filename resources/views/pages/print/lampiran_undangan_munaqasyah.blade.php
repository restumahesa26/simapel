...
<body>
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="col-4">
                <h4
                    ...
                    {{ $mahasiswas->first()->ruang_sidang }}</h4>
            </div>
        </div>
        <div class="text-center mb-3 mt-3">
            <p class="font-weight-bold" style="font-size: 17px;">JADWAL MUNAQASAH SKRIPSI</p>
        ...
        <p>Penanggung jawab dan Sekretaris : {{ $mahasiswas->first()->sekretaris }}</p>
        <table class="table table-bordered mt-3">
            <thead>
                <tr class="text-center ">
                    <th style="width: 3%; vertical-align: middle;">No</th>
                    <th style="width: 11%; vertical-align: middle;">Hari / Tanggal</th>
                    <th style="width: 4%; vertical-align: middle;">Jam</th>
                    ...
                    <th style="width: 8%;">Jabatan Pembahas</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">{{ \Carbon\Carbon::parse($item->tanggal_sidang)->translatedFormat('l') }}<br>{{ \Carbon\Carbon::parse($item->tanggal_sidang)->translatedFormat('d F Y') }}</td>
                    <td class="text-center">{{ \Carbon\Carbon::parse($item->jam_mulai_sidang)->translatedFormat('H:i') }} <br> s.d <br> {{ \Carbon\Carbon::parse($item->jam_selesai_sidang)->translatedFormat('H:i') }}</td>
                    ...
                    <td class="text-justify">{{ $item->user->judul_skripsi->judul_skripsi }}</td>
                    <td>
                        <ul style="margin-left: -35px !important; list-style: none; margin-bottom: 0 !important">
                            ...
                            <li>{{ $item->dosen_penguji_1 }}</li>
                            <li>{{ $item->dosen_penguji_2 }}</li>
                        </ul>
                    </td>
                    <td>
                        <ul style="margin-left: -35px !important; list-style: none; margin-bottom: 0 !important">
        ...
        <ul>
            <li style="font-size: 14px;">Mahasiswa Wajib Hadir 15 Menit Sebelum Ujian Dimulai.</li>
            <li style="font-size: 14px;">Mahasiswa Wajib Mengenakan Pakaian Ujian (Hitam Putih, dan Memakai Jas
                Almamater).</li>
        </ul>
        <div class="d-flex justify-content-end" style="margin-right: 70px; margin-top: -15px;">
            <div class="column">
