                        ...
                        <tbody>
                            @forelse ($items as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.kartu-bimbingan.show', $item->id) }}" class="btn btn-sm btn-primary">Lihat Data</a>
                                        <form action="{{ route('admin.kartu-bimbingan.delete', $item->id) }}" method="post" class="d-inline">
                                            @csrf
                                            @method('DELETE')
